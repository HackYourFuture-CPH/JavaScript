...
Steps:
* Fork this repository: https://github.com/HackYourFuture-CPH/hyf-homework
* Clone the repository down on your own computer 
* Add your homework files in the Javascript/javascript1/week1 folder
